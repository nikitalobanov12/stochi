...
export const stackTemplates: StackTemplate[] = [
  ...
  // ============================================================================
  {
    ...
    description:
      "Mag Threonate + Theanine + Apigenin for deep, restorative sleep",
    usage:
      "Take 30-60 minutes before bed. Start with Theanine alone for 2-3 days, then add others.",
  ...
  },
  {
    ...
    usage:
      "Take on empty stomach, 30-45 min before demanding cognitive work. Skip on rest days.",
    source: "Huberman Lab Podcast",
  ...
  },
  {
    ...
    description:
      "Evidence-based longevity foundation with omega-3s and vitamin D",
    usage:
      "Take with breakfast containing fat. Consistent daily use for benefits.",
  ...
  // ============================================================================
  {
    ...
    usage:
      "D3/K2 with fatty meal for absorption. Magnesium at night for sleep.",
  ...
  },
  {
    ...
    usage:
      "2:1 Theanine to Caffeine ratio. Take as morning alternative to plain coffee.",
    source: "Examine.com",
  ...
  },
  {
    ...
    description:
      "Ashwagandha + Rhodiola for cortisol management and stress adaptation",
  ...
  },
  {
    ...
    usage:
      "Daily during cold season or when feeling run down. Zinc with food to avoid nausea.",
  ...
  },
  {
    ...
    name: "Joint Support",
    description:
      "Collagen + Vitamin C + Omega-3 for joint and connective tissue health",
    usage:
      "Vitamin C enhances collagen synthesis. Take consistently for 8+ weeks.",
    ...
    supplements: [
      {
        ...
        dosage: 10,
        unit: "g",
        timing: "Morning, any time",
      },
      {
        supplementName: "Vitamin C",
        dosage: 500,
        unit: "mg",
        timing: "With collagen",
      },
      {
        supplementName: "Omega-3 Fish Oil",
        dosage: 2000,
  ...
  },
  {
    ...
    description:
      "Creatine + Beta-Alanine + Citrulline for strength and endurance",
    usage:
      "Creatine daily (timing doesn't matter). Others 30 min before training.",
  ...
  },
  {
    ...
    name: "Mood Support",
    description:
      "Omega-3 + Vitamin D + Magnesium for mood and emotional balance",
  ...
  },
  {
    ...
    name: "Vision Support",
    description:
      "Lutein + Zeaxanthin + Omega-3 for macular health and eye strain",
  ...
  // ============================================================================
  {
    ...
    name: "Sleep Rescue",
    description:
      "Glycine + Magnesium + Tart Cherry for occasional sleep support",
  ...
  // ============================================================================
  {
    ...
    usage:
      "SubQ injection near injury site. 4-6 week protocol. Store peptides in fridge.",
    ...
    supplements: [
      {
        supplementName: "BPC-157",
        dosage: 250,
        unit: "mcg",
        route: "subq_injection",
        timing: "1-2x daily",
      },
      {
        supplementName: "TB-500",
        dosage: 2,
        unit: "mg",
        route: "subq_injection",
        timing: "2x per week",
  ...
  },
  {
    ...
    usage:
      "Intranasal spray. SEMAX for focus, Selank for anxiety. Can use together or separately.",
...
export function getStacksByGoals(goals: GoalKey[]): StackTemplate[] {
  ...
  return stackTemplates.filter((t) => t.goals?.some((g) => goals.includes(g)));
}
